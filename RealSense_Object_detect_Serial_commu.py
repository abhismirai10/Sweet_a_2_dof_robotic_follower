...
def initialize_trackbars(trackbar_handler):
    ...
    cv2.createTrackbar('Hue Low', 'MyTrackbar', 100, 179, trackbar_handler.on_hue_low)
    cv2.createTrackbar('Hue High', 'MyTrackbar', 108, 179, trackbar_handler.on_hue_high)
    cv2.createTrackbar('Sat Low', 'MyTrackbar', 226, 255, trackbar_handler.on_sat_low)
    cv2.createTrackbar('Sat High', 'MyTrackbar', 255, 255, trackbar_handler.on_sat_high)
    cv2.createTrackbar('Val Low', 'MyTrackbar', 138, 255, trackbar_handler.on_val_low)
    cv2.createTrackbar('Val High', 'MyTrackbar', 211, 255, trackbar_handler.on_val_high)
        ...
        while True:
            ...
            for contour in contours:
                ...
                if area > 50:
                    ...
                    print("x center: ",(center_x), "y center: ",(center_y))
                    error_yaw = center_x - (width/2)
                    error_pitch = center_y - (height/2)
